...
const char *ERROR_CODE_STRING[] = {
    ...
    [ERROR_OPERATOR_PLACEMENT]      = "ERROR_OPERATOR_PLACEMENT",
    [ERROR_MISSING_OPERATOR]        = "ERROR_MISSING_OPERATOR",
    [ERROR_FUNCTION_PLACEMENT]      = "ERROR_FUNCTION_PLACEMENT",
    [ERROR_COMMA_PLACEMENT]         = "ERROR_COMMA_PLACEMENT",
    [ERROR_RBRACKET_PLACEMENT]      = "ERROR_RBRACKET_PLACEMENT",
    [ERROR_EVALUATING_EXPRESSION]   = "ERROR_EVALUATING_EXPRESSION",
